<?php 
 ...
 ?>
<div style="background-color:#cccccc; height: 250px; padding: 20px; border-radius: 50px; ">
   <div>
        <img src="<?php echo $r['pro_pic']; ?>" style=" box-shadow: 10px 10px 10px 5px #888888; border-radius: 50%; border-color: #939393; border-width: 5px; border-style: solid; width: 200px; height: 200px;">
    </div>
    <div style="margin: -100px 50px 50px 250px;">
        <h1 style="color: #36466f">Welcome <?php echo $r['name']; ?></h1>
    </div>
</div>
<div style="padding: 10px; box-shadow: 10px 10px 10px 5px #888888; margin: 30px; background-color:white; border-radius:10px;">
    <div>
        <form method="POST" action="userpost.php">
            <img src="<?php echo $r['pro_pic']; ?>" height="50px" width="50px" style=" box-shadow: 5px 5px 10px 3px #888888; margin:5px 5px 5px 30px; border-radius: 50%; border-color: #939393; border-width: 5px; border-style: solid;">
        
            <input style="margin: -100px 10px 5px 40px; width: 550px; height: 45px; background-color: #2d2d61; color: white; border: none; border-radius:10px;" type="submit" value="Explore yourself!!!">
        </form>
    </div>
</div>
  <?php
...
//            echo $r2;
            ...
            {
                echo '<a href="like.php?id='.$r['post_id'].'&s=like&c=0"><img src="images/GAME-EXPAND_heart_line-512.png" width="50px" height="50px"></a>';
                echo '<span style="margin-left:3px">'.$r['likes'].'</span>';
                echo '<a href="like.php?id='.$r['post_id'].'&s=unlike&c=0"><img src="images/18-512.png" width="55px" height="47px"></a>';
            ...
            {   
                ...
                {
                    echo  '<a href="like.php?id='.$r['post_id'].'&s=unlike&c=1"><img src="images/Instagram-Like-Icon.png" width="45px" height="45px"></a>';
                    echo '<span style="margin-left:3px">'.$r['likes'].'</span>';
                ...
                else if($r1['like']=="dislike")//if it is dislike
                {
                    ...
                    echo '<span style="margin-left:3px">'.$r['likes'].'</span>';
                    echo '<a href="like.php?id='.$r['post_id'].'&s=unlike&c=2"><img src="images/183-1831107_broken-heart-icon-heart-broken-heart-png.png" width="50px" height="50px"></a>';
                    echo '<span style="margin-left:3px">'.$r['dislikes'].'</span>';
                }
            }
            echo '</div>';

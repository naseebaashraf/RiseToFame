<?php 
 ...
 ?>
  ...
  <?php
        $q="select * from tbl_post where  post_id='$pid'";
        $s= mysqli_query($conn, $q);?>
...
//            echo $q1;
            ...
            if($ex==".jpg" || $ex=="jpeg" || $ex==".gif" || $ex==".bmp")
                ...
                echo '<div style="padding: 20px; margin: 10px; border-color: #939393; border-width: 5px; border-style: solid;">'
                . '<a href="'.$r['file'].'"><video style="height: 450px; width:750px;" autoplay="autoplay" controls="controls">
...
//            echo $r2;
            ...
            ///////comments
            $q2="select tbl_users.name,tbl_comment.com from tbl_users,tbl_comment where tbl_comment.post_id='".$r['post_id']."' and tbl_comment.email=tbl_users.email order by tbl_comment.comment_id ";
